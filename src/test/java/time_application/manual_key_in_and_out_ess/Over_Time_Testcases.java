...
public class Over_Time_Testcases extends Browser_Launch {
	...
	@Test(priority = 1)
	public void tc48_Overtime_Cancellation_before_Approval() throws AWTException, InterruptedException, IOException {
	...
	@Test(priority = 2)
	public void tc37_Overtime_for_Approval() throws AWTException, InterruptedException, IOException {
		...
		Time_Records_Page_calls.ot_Approve_In_Manager(day, month);
		Home_Page_calls.giving_Manager_Comment();
		Home_Page_calls.toaster_Message_Check_OT_Approval();
	...
	//, dependsOnMethods = "tc37_Overtime_for_Approval"
	@Test(priority = 3 , dependsOnMethods = "tc37_Overtime_for_Approval")
	public void tc49_Overtime_Cancellation_After_Approval() throws AWTException, InterruptedException, IOException {
		...
		//checking allowance
        Time_Records_Page_calls.entry_OT_Check(day  , month);

		// canceling the record
		Time_Records_Page_calls.search_Data_Click_Cancel_OT(day, month);

...
public class Mss_My_Records_Suite extends Browser_Launch {
    ...
    public void tc1_Search_Option_To_valdiate_if_an_employee_is_able_to_search_the_time_records()
        ...
        //search validation
        Mss_My_Time_record_Page_calls.search_validation();
    ...
    public void tc7_Filter_To_validate_if_an_employee_is_able_to_filter_any_specific_records_as_per_selection() throws Exception {
		...
		String filter_value="30-Apr-2023";
    ...
    @Test(priority = 4,dependsOnMethods = "tc3_Previous_Paycycle_Data_To_validate_if_an_employee_can_view_the_time_records_for_previous_paycycle")
    ...
    @Test(priority = 6)
    public void tc21_Show_Exception() throws AWTException, InterruptedException, IOException {
    ...
    @Test(priority = 7)
    public void tc22_Show_Variance_Entry_Type_Over_Time() throws AWTException, InterruptedException, IOException {
        ...
        //Overtime checking
        Mss_My_Time_Record_Page_calls.show_Variance_Check();
